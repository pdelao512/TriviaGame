//Create a array for the gif's associated with each question.
// Create variables for for questions and anawers.
...
var answered; 
var userSelect;
// Create variables and message  to be displayed for correct, wrong, times up, and finished answer.  
var messages = {
	correct: "Yes, that's right!",
	wrong: "You just got slapped!",
	endTime: "Out of time!",
	finished: "Alright! Let's see how well you did."
}
// create 15 questions and multiple choice answers. Along with the correct answer 
var triviaQuestions = [{
...
// add events function to start the game.
...
// add anwer page function, along with if and else statments.
function answerPage(){
	...
	if((userSelect == rightAnswerIndex) && (answered == true)){
		...
		$("#correctedAnswer").html("WRONG!!The correct answer was: " + rightAnswerText);
	} else{
		unanswered++;
		$("#message").html(messages.endTime);
		$("#correctedAnswer").html("Sorry. The correct answer was: " + rightAnswerText);
		answered = true;
	}
